...
function createDbAccessor(name) {
  ...
  function createDocument(data) {
    ...
    return couchdb
      .put(`/${name}/${sanitizeId(data._id)}`, omit('_id')(data))
      .then(normalizeData)
      .then(returnData)
  }
  ...
  function deleteDocument({ _id, _rev }, options) {
    ...
    return couchdb
      .delete(`/${name}/${sanitizeId(_id)}?rev=${_rev}`, axiosOptions)
  ...
  function getDocument({ _id }, options) {
    ...
    return couchdb
      .get(`/${name}/${sanitizeId(_id)}`, axiosOptions)
      .then(maybeTransformResponse)
  }
  ...
  function getDocumentAtRevision({ _id, _rev }) {
    ...
    return couchdb
      .get(`/${name}/${sanitizeId(_id)}?rev=${_rev}`)
      .then(returnData)
  }
  ...
  function updateDocument(data) {
    ...
    return couchdb
      .put(`/${name}/${sanitizeId(_id)}?rev=${_rev}`, data)
      .then(normalizeData)
      .then(returnData)
  }
}
